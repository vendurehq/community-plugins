...
generated: true
---
<GenerationInfo sourceFile="packages/braintree-plugin/src/braintree.plugin.ts" sourceLine="240" packageName="@vendure-community/braintree-plugin" />
...
<MemberInfo kind="property" type={`<a href='/reference/core-plugins/braintree-plugin/braintree-plugin-options#braintreepluginoptions'>BraintreePluginOptions</a>`}   />


### init

<MemberInfo kind="method" type={`(options: <a href='/reference/core-plugins/braintree-plugin/braintree-plugin-options#braintreepluginoptions'>BraintreePluginOptions</a>) => Type<<a href='/reference/core-plugins/braintree-plugin/#braintreeplugin'>BraintreePlugin</a>>`}   />
