...
generated: true
---
<GenerationInfo sourceFile="packages/stripe-plugin/src/stripe.plugin.ts" sourceLine="160" packageName="@vendure-community/stripe-plugin" />
...
<GenerationInfo sourceFile="packages/stripe-plugin/src/types.ts" sourceLine="29" packageName="@vendure-community/stripe-plugin" />
