...
generated: true
---
<GenerationInfo sourceFile="packages/mollie-plugin/src/mollie.plugin.ts" sourceLine="231" packageName="@vendure-community/mollie-plugin" />
...
<GenerationInfo sourceFile="packages/mollie-plugin/src/mollie.plugin.ts" sourceLine="28" packageName="@vendure-community/mollie-plugin" />
