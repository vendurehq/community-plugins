...
generated: true
---
<GenerationInfo sourceFile="packages/braintree-plugin/src/braintree.plugin.ts" sourceLine="241" packageName="@vendure-community/braintree-plugin" />
...
<GenerationInfo sourceFile="packages/braintree-plugin/src/types.ts" sourceLine="26" packageName="@vendure-community/braintree-plugin" />
