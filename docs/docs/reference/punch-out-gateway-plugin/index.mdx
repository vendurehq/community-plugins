...
generated: true
---
<GenerationInfo sourceFile="packages/punchout-gateway-plugin/src/punchout-gateway-plugin.ts" sourceLine="31" packageName="@vendure-community/punchout-gateway-plugin" />
