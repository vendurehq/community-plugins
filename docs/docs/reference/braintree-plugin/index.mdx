...
<MemberInfo kind="property" type={`<a href='/reference/braintree-plugin/braintree-plugin-options#braintreepluginoptions'>BraintreePluginOptions</a>`}   />


### init

<MemberInfo kind="method" type={`(options: <a href='/reference/braintree-plugin/braintree-plugin-options#braintreepluginoptions'>BraintreePluginOptions</a>) => Type<<a href='/reference/braintree-plugin/#braintreeplugin'>BraintreePlugin</a>>`}   />
