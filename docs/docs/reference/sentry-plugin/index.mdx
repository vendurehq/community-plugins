...
generated: true
---
<GenerationInfo sourceFile="packages/sentry-plugin/src/sentry-plugin.ts" sourceLine="26" packageName="@vendure-community/sentry-plugin" />
...
<MemberInfo kind="property" type={`<a href='/reference/sentry-plugin/sentry-plugin-options#sentrypluginoptions'>SentryPluginOptions</a>`}   />


### init

<MemberInfo kind="method" type={`(options?: <a href='/reference/sentry-plugin/sentry-plugin-options#sentrypluginoptions'>SentryPluginOptions</a>) => `}   />
