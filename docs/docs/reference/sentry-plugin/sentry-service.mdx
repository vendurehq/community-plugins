...
generated: true
---
<GenerationInfo sourceFile="packages/sentry-plugin/src/sentry.service.ts" sourceLine="13" packageName="@vendure-community/sentry-plugin" />
...
<MemberInfo kind="method" type={`(options: <a href='/reference/sentry-plugin/sentry-plugin-options#sentrypluginoptions'>SentryPluginOptions</a>) => SentryService`}   />
