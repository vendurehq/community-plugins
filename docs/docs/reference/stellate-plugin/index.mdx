...
generated: true
---
<GenerationInfo sourceFile="packages/stellate-plugin/src/stellate-plugin.ts" sourceLine="244" packageName="@vendure-community/stellate-plugin" since="2.1.5" />
...
which defines the Stellate service name and API token, as well as an array of [PurgeRule](/reference/stellate-plugin/purge-rule#purgerule)s which
...
purge those entities from the cache when they are updated. This is where the [PurgeRule](/reference/stellate-plugin/purge-rule#purgerule) comes in.
...
You can then add a custom [PurgeRule](/reference/stellate-plugin/purge-rule#purgerule) to the StellatePlugin configuration:
...
<MemberInfo kind="property" type={`<a href='/reference/stellate-plugin/stellate-plugin-options#stellatepluginoptions'>StellatePluginOptions</a>`}   />


### init

<MemberInfo kind="method" type={`(options: <a href='/reference/stellate-plugin/stellate-plugin-options#stellatepluginoptions'>StellatePluginOptions</a>) => `}   />


### constructor

<MemberInfo kind="method" type={`(options: <a href='/reference/stellate-plugin/stellate-plugin-options#stellatepluginoptions'>StellatePluginOptions</a>, eventBus: EventBus, stellateService: <a href='/reference/stellate-plugin/stellate-service#stellateservice'>StellateService</a>, moduleRef: ModuleRef) => StellatePlugin`}   />
