...
generated: true
---
<GenerationInfo sourceFile="packages/stellate-plugin/src/stellate-plugin.ts" sourceLine="27" packageName="@vendure-community/stellate-plugin" since="2.1.5" />
...
```shell
npm install @vendure-community/stellate-plugin
```
...
```ts
import { StellatePlugin, defaultPurgeRules } from '@vendure-community/stellate-plugin';
