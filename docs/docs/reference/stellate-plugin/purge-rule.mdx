...
the provided [StellateService](/reference/stellate-plugin/stellate-service#stellateservice) instance.
...
<MemberInfo kind="method" type={`(handlerArgs: { events: Event[]; stellateService: <a href='/reference/stellate-plugin/stellate-service#stellateservice'>StellateService</a>; injector: Injector }) => `}   />


### constructor

<MemberInfo kind="method" type={`(config: <a href='/reference/stellate-plugin/purge-rule#purgeruleconfig'>PurgeRuleConfig</a><Event>) => PurgeRule`}   />
...
Configures a [PurgeRule](/reference/stellate-plugin/purge-rule#purgerule).
...
<MemberInfo kind="property" type={`(handlerArgs: {         events: Event[];         stellateService: <a href='/reference/stellate-plugin/stellate-service#stellateservice'>StellateService</a>;         injector: Injector;     }) => void | Promise<void>`}   />

The function to invoke when the specified event is published. This function should use the
[StellateService](/reference/stellate-plugin/stellate-service#stellateservice) instance to call the Stellate Purge API.
