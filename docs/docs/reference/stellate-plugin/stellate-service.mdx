...
<MemberInfo kind="method" type={`(options: <a href='/reference/stellate-plugin/stellate-plugin-options#stellatepluginoptions'>StellatePluginOptions</a>) => StellateService`}   />
