...
generated: true
---
<GenerationInfo sourceFile="packages/stellate-plugin/src/types.ts" sourceLine="9" packageName="@vendure-community/stellate-plugin" />
...
<MemberInfo kind="property" type={`<a href='/reference/stellate-plugin/purge-rule#purgerule'>PurgeRule</a>[]`}   />

An array of [PurgeRule](/reference/stellate-plugin/purge-rule#purgerule) instances which are used to define how the plugin will
