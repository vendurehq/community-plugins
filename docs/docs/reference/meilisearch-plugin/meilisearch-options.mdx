...
generated: true
---
<GenerationInfo sourceFile="packages/meilisearch-plugin/src/options.ts" sourceLine="193" packageName="@vendure-community/meilisearch-plugin" />
...
<MemberInfo kind="property" type={`AiSearchConfig`} default={`undefined (AI search disabled)`}   />
