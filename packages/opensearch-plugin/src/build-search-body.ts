...
import { CustomScriptMapping, OpenSearchInput, OpenSearchSortInput, SearchRequestBody } from './types';

/**
 * Given a SearchInput object, returns the corresponding OpenSearch body.
 */
export function buildSearchBody(
    ...
    const sortArray: OpenSearchSortInput = [];
    if (sort) {
        if (sort.name) {
            sortArray.push({
