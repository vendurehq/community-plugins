...
export function generateSchemaExtensions(options: OpenSearchOptions): DocumentNode {
...
function generateCustomMappingTypes(options: OpenSearchOptions): DocumentNode | undefined {
