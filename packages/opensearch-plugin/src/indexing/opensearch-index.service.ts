...
import { OpenSearchIndexerController, ReindexMessageResponse } from './indexer.controller';

@Injectable()
export class OpenSearchIndexService implements OnApplicationBootstrap {
    private updateIndexQueue: JobQueue<UpdateIndexQueueJobData>;

    constructor(
        private jobService: JobQueueService,
        private indexerController: OpenSearchIndexerController,
    ) {}
