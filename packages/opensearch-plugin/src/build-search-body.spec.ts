...
describe('buildSearchBody()', () => {
    ...
    it('collectionIds', () => {
        const result = buildSearchBody({ collectionIds: ['1', '2'] }, searchConfig, CHANNEL_ID, LanguageCode.en);
        expect(result.query).toEqual({
            bool: {
    ...
    it('enabledOnly true', () => {
        const result = buildSearchBody({}, searchConfig, CHANNEL_ID, LanguageCode.en, true, ctx);
        expect(result.query).toEqual({
            bool: {
    ...
    it('enabledOnly false', () => {
        const result = buildSearchBody({}, searchConfig, CHANNEL_ID, LanguageCode.en, false, ctx);
        expect(result.query).toEqual({
