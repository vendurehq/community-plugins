...
export type OpenSearchResult = SearchResult & {
    inStock: boolean;
};

export type OpenSearchInput = SearchInput & {
...
export type OpenSearchResponse = SearchResponse & {
...
export enum OpenSearchSortMode {
...
export type OpenSearchSortParameter = {
    missing?: '_last' | '_first' | string;
    mode?: OpenSearchSortMode;
    order: 'asc' | 'desc';
} & { [key: string]: any };

export type OpenSearchSortInput = Array<{ [key: string]: OpenSearchSortParameter }>;
